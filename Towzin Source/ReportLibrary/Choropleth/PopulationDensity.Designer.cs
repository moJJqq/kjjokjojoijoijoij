namespace Telerik.Reporting.Examples.CSharp
{
    partial class PopulationDensity
    {
        ...
        '\n'};
            ...
            this.shapeMapSeries1.ToolTip.Text = "=Format('Area: {0} km²;\r\nPopulation: {1};\r\nDensity: {2:0.00} ppl/km²', Fields.SQKM, Fields.POP_CNTRY, Fields.POP_CNTRY/Fields.SQKM)";
            // 
            ...
            this.textBoxTitle.Size = new Telerik.Reporting.Drawing.SizeU(Telerik.Reporting.Drawing.Unit.Cm(5.8D), Telerik.Reporting.Drawing.Unit.Cm(0.800000011920929D));
